        ...
        while(1){
            ...
            if( rec<=0 ){
                ...
                if(count == r.size){
                    ...
                    /*while(rec=recvfrom( sockfd , &r , sizeof(type) , 0 , (struct sockaddr*) &sender , &length )){
                        if(rec<=0)
                            break;
                        else 
                            cout<<"now r.now"<<r.now<<endl;
                        if(r.refresh){
                            sendto( sockfd, &temp[r.now] , sizeof(type) , 0 , (struct sockaddr*) &sender , length );
                        }
